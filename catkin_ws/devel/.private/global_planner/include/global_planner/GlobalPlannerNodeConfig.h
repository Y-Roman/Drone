...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(GlobalPlannerNodeConfig::AbstractParamDescriptionConstPtr(new GlobalPlannerNodeConfig::ParamDescription<std::string>("default_node_type_", "str", 4, "Change search mode", "{'enum_description': 'Change search mode', 'enum': [{'srcline': 44, 'description': 'Normal node', 'srcfile': '/home/user/catkin_ws/src/PX4-Avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'cconsttype': 'const char * const', 'value': 'Node', 'ctype': 'std::string', 'type': 'str', 'name': 'Node'}, {'srcline': 45, 'description': 'No smooth cost', 'srcfile': '/home/user/catkin_ws/src/PX4-Avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'cconsttype': 'const char * const', 'value': 'NodeWithoutSmooth', 'ctype': 'std::string', 'type': 'str', 'name': 'NodeWithoutSmooth'}, {'srcline': 46, 'description': 'Search with speed', 'srcfile': '/home/user/catkin_ws/src/PX4-Avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'cconsttype': 'const char * const', 'value': 'SpeedNode', 'ctype': 'std::string', 'type': 'str', 'name': 'SpeedNode'}]}", &GlobalPlannerNodeConfig::default_node_type_)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(GlobalPlannerNodeConfig::AbstractParamDescriptionConstPtr(new GlobalPlannerNodeConfig::ParamDescription<std::string>("default_node_type_", "str", 4, "Change search mode", "{'enum_description': 'Change search mode', 'enum': [{'srcline': 44, 'description': 'Normal node', 'srcfile': '/home/user/catkin_ws/src/PX4-Avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'cconsttype': 'const char * const', 'value': 'Node', 'ctype': 'std::string', 'type': 'str', 'name': 'Node'}, {'srcline': 45, 'description': 'No smooth cost', 'srcfile': '/home/user/catkin_ws/src/PX4-Avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'cconsttype': 'const char * const', 'value': 'NodeWithoutSmooth', 'ctype': 'std::string', 'type': 'str', 'name': 'NodeWithoutSmooth'}, {'srcline': 46, 'description': 'Search with speed', 'srcfile': '/home/user/catkin_ws/src/PX4-Avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'cconsttype': 'const char * const', 'value': 'SpeedNode', 'ctype': 'std::string', 'type': 'str', 'name': 'SpeedNode'}]}", &GlobalPlannerNodeConfig::default_node_type_)));
...
//#line 44 "/home/user/catkin_ws/src/PX4-Avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
      const char * const GlobalPlannerNode_Node = "Node";
//#line 45 "/home/user/catkin_ws/src/PX4-Avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
      const char * const GlobalPlannerNode_NodeWithoutSmooth = "NodeWithoutSmooth";
//#line 46 "/home/user/catkin_ws/src/PX4-Avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
